...
<body>
<hr size=2>
<h2 align="center"><span class="style2">Alter stock</h2>
...
if  (request.getParameter("stock") != null) {
    addStock =   request.getParameter("stock");   
    if  (! addStock.equals("")){
        msg         =   new Message("(ask :receiver stockManager)");
        cont        =   Literal.parseLiteral("alterStock("+codeBookLis+","+addStock+")");
        msg.put("content", cont);
        answer      =   mbox.ask(msg);
        contentStock    =   answer.get("content").toString().replaceAll("\"","");;
     }
}
...
if  (!title.equals("Book not found")) { %>
    ...
    <%if  (!contentStock.equals("")) { 
        %><span class="style1"><b>New stock is <%= contentStock %></b><p>  <%
    }
    %>
    <input name="stock" align="right" value="" type="text" id="stock" size="10" maxlength="10" />
    <input name="sbmtStatus" type="submit" value="Add"/>
<%  }   %>
